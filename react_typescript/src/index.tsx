...
// Context API 또는 redux는 프로젝트를 전박적으로 사용할 state를 저장하기 위한 공간

const 초기값: { count: number; user: string } = { count: 0, user: "홍길동" };

//createStore --> createSlice
//createSlice 에는 name, initialState, reducers 만들어줘야함
const countSlice = createSlice({
  //createSlice 객체로 값을 넣어줘야 한다. name, initialState, reducers
  name: "counter",
  initialState: 초기값,
  reducers: {
    증가(state) {
...
// 초기값을 설정해주는 코드 전역적으로 보관
// 변수를 사용하려면 useSelector 로 사용 가능
